...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ITGxP — Enterprise IT & GxP Compliance for Regulated Industries" },
      { name: "description", content: "Enterprise IT Managed Services and GxP Compliance for life sciences, healthcare and regulated enterprises. FDA, EMA, GAMP 5, 21 CFR Part 11." },
      { name: "author", content: "ITGxP" },
      { property: "og:title", content: "ITGxP — Enterprise IT & GxP Compliance for Regulated Industries" },
